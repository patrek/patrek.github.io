...
It is a very interesting way to make sure you have a good starting point for all your documentation.

=== Architectural Decision Records https://adr.github.io/[ADR]

From a project start, we make architectural decisions.
As time goes by, the people and the memory of those decision and why they were taken get lost.
