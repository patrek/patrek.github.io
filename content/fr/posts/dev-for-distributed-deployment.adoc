...
L'idée de cet article m'est venue, en début d'année, après ma publication sur les éléments à considérer quand on link:/fr/posts/green-field/[démarre un projet de développement] et en discutant avec des collègues qui commençaient à apprendre un environnement cloud.
...
Les feature flags (drapeaux de fonctionnalités) permettent d'activer ou désactiver des fonctionnalités sans recompiler l'application, ou même la redéployer si vous mettez en place une façon d'en prendre compte pendant que l'application roule. Cette stratégie peut être très utile, notamment pour :
